...
int main(){
    ...
    //Shader 작성
    Shader shader("src/shaders/14_6shader.vs", "src/shaders/14_6shader.fs");
    Shader skyboxShader("src/shaders/14_6skybox_shader.vs", "src/shaders/14_6skybox_shader.fs");
