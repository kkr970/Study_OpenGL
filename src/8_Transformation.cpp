...
int main(){
    ...
    //Shader 작성
    Shader ourShader("src/shaders/8shader.vs", "src/shaders/8shader.fs");
    ...
    {   
        ...
        //변환행렬1
        //trans = glm::rotate(trans, glm::radians(90.0f), glm ::vec3(0.0f, 0.0f, 1.0f)); //trans를 라디안(90도)만큼 0,0,1축으로 회전
        //trans = glm::scale(trans, glm::vec3(0.5f, 0.5f, 0.5f));//trans를 0.5 0.5 0.5 만큼 스케일
