...
int main(){
    ...
    //Shader 작성
    Shader ourShader("src/shaders/10shader.vs", "src/shaders/10shader.fs");
    ...
    {   
        ...
        for(unsigned int i = 0; i < 10; i++)
        {
            ...
            float angle = 20.0f * i; 
            model = glm::rotate(model, glm::radians( angle+(float)glfwGetTime()*60.0f ), glm::vec3(1.0f, 0.3f, 0.5f));
